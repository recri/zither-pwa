...
[ ] fretboard showing at bottom of splash, on the IPad Mini
...
[ ] if you're at B0 on a bass fretboard, there is no octave below.
    ...
    we only allow +/- relative semitone adjustments of transpose.
[ ] midi output
[ ] midi input
[ ] osc output
[ ] osc input
...
[ ] no sound on iphone, need to select output maybe?
[ ] make the contents of the tab panels inf the ui be scrollable.
[ ] recombine the tab panels recently split
[ ] make a pref tab panel which saves, edits, names, deletes, and runs urls
