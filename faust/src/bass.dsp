...
reflexionFilter = poleZero(b0,b1,a1)
	   with{
		...
		b0 = 0.54355; // loopFilterb0(freqn); first entry in table
		b1 = -0.36586; //loopFilterb1(freqn); first entry in table
		a1 = -0.81486; //loopFiltera1(freqn); first entry in table
	   };
