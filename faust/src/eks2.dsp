declare name "NLFeks2";
declare author "Julius Smith and Romain Michon, hacked by Roger Critchlowa";
declare version "1.0";
...
beta = hslider("pick_position [midi: ctrl 0x81]", 0.13, 0.02, 0.98, 0.01);
