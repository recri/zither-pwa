          ...
          <sl-tab-panel name="tuning"
            ><div class="content">
              ...
              >
                ...
                ${slTuning('b', 'D4,D3,G3,B3,D4', 'banjo 5 standard')}
                ...
                ${slTuning(
                  'o',
                  'F5,E5,D5,C5,B4,A4,G♯4,F4,E4,D4',
                  'lyre harp 10',
                )}
                ${slTuning(
                  'o',
	    ...
	    bass-alt {D1 A1 D2 G2} -->
              ...
              >
                ...
                ${[
                  ...
                  tonic =>
                    html`<sl-option value="${tonic}">${tonic}</sl-option>`,
                )}
              </sl-select>
              ...
              >
                ...
                ${[
                  ...
                  scale =>
                    html`<sl-option value="${scale}">${scale}</sl-option>`,
                )}
              </sl-select>
              ...
              >
                ...
                ${[
                  ...
                  color =>
                    html`<sl-option value="${color}">${color}</sl-option>`,
                )}
              </sl-select>
            </div></sl-tab-panel
          >
